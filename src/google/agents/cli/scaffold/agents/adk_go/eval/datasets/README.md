...
### Custom Dataset
```bash
agents-cli eval run --dataset eval/datasets/custom-dataset.json --metrics general_quality
```
...
```bash
agents-cli eval generate --dataset eval/datasets/custom-dataset.json --output custom_traces/
